...
SELECT
  ...
  #area_grwn_000_ha as area_grown_000_ha, Step 28 to comment this field
...
FROM
  `bcs-edf-ingestion-np.gc_agrowin_cz.cssi_agrwn_actv_ready_mix_lvl`