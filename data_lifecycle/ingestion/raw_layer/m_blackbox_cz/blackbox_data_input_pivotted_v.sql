...
SELECT * FROM `bcs-edf-ingestion-np.m_blackbox_cz.blackbox_data_input_v`
UNPIVOT
(
  Bayer
  FOR Year in (
...
(
  ...
  Blackbox_2025 AS "2025",
  Blackbox_2026 AS "2026",
  Blackbox_2027 AS "2027")
)
),
...
(
  ...
  Comments_2025 AS "2025",
  Comments_2026 AS "2026",
  Comments_2027 AS "2027")
)
)
SELECT Bayer_Pivotted.Quarter,Bayer_Pivotted.Indication,Bayer_Pivotted.Local_Currency_code,Bayer_Pivotted.Country,Bayer_Pivotted.Year,Bayer_Pivotted.Bayer,Blackbox_Pivotted.Blackbox,Comments_Pivotted.Comments
